...
import (
  ...
  _ "github.com/gmlewis/go-fonts-b/fonts/baskervville_regular"
)

func main() {
  // ...
  xPos, yPos, xScale, yScale := 0.0, 0.0, 1.0, 1.0
  message := "Sample from baskervville_regular"
  render, err := fonts.Text(xPos, yPos, xScale, yScale, message, "baskervville_regular", &fonts.Center)
  if err != nil {
    log.Fatal(err)
  }
