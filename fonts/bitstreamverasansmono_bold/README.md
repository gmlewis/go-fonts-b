...
import (
  ...
  _ "github.com/gmlewis/go-fonts-a/fonts/bitstreamverasansmono_bold"
)

func main() {
  // ...
  xPos, yPos, xScale, yScale := 0.0, 0.0, 1.0, 1.0
  message := "Sample from bitstreamverasansmono_bold"
  render, err := fonts.Text(xPos, yPos, xScale, yScale, message, "bitstreamverasansmono_bold", &fonts.Center)
  if err != nil {
    log.Fatal(err)
  }
