...
import (
  ...
  _ "github.com/gmlewis/go-fonts-a/fonts/baskervville_italic"
)

func main() {
  // ...
  xPos, yPos, xScale, yScale := 0.0, 0.0, 1.0, 1.0
  message := "Sample from baskervville_italic"
  render, err := fonts.Text(xPos, yPos, xScale, yScale, message, "baskervville_italic", &fonts.Center)
  if err != nil {
    log.Fatal(err)
  }
