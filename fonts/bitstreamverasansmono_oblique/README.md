...
import (
  ...
  _ "github.com/gmlewis/go-fonts-a/fonts/bitstreamverasansmono_oblique"
)

func main() {
  // ...
  xPos, yPos, xScale, yScale := 0.0, 0.0, 1.0, 1.0
  message := "Sample from bitstreamverasansmono_oblique"
  render, err := fonts.Text(xPos, yPos, xScale, yScale, message, "bitstreamverasansmono_oblique", &fonts.Center)
  if err != nil {
    log.Fatal(err)
  }
